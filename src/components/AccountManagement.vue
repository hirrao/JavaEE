      ...
      <el-table class="table" :data="Account">
        ...
        <el-table-column header-align="center" align="center" label="操作">
          <template v-slot="scoped">
            <el-button class="tableButton" type="primary" icon="el-icon-edit" @click="updateAccount(scoped.row)">更新</el-button>
            <el-button class="tableButton" type="danger" icon="el-icon-delete" @click="deleteAccount(scoped.row.uid)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <el-dialog title="修改账号信息" v-model="dialogVisble" width="50%">
      <el-form ref="form" :model="modifyAccount" label-width="150px" style="margin-left: auto;margin-right: auto;">
          ...
          <el-form-item label="生日" prop="birthday">
              <el-date-picker v-model="modifyAccount.birthday"
...
<script setup lang="ts">
    ...
    function updateAccount(row: { uid: string; userName: string; phoneNumber: string; sex: string; birthday: string; permission: string; }){
    ...
    function searchByPage(){
        instance.post("/user/searchUserByCondition",{
    ...
    function AddRecord(){
      instance.post("/user/modifyUserInfo",{
