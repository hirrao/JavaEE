...
public interface BloodPressureMapper extends BaseMapper<BloodPressure> {
    ...
    @Insert("INSERT INTO bloodPressureLog(bplId, uid, SBP, DBP, recordTime) VALUES(#{bplId},#{uid}, #{SBP}, #{DBP}, #{recordTime})")
    void insertBloodPressure(long bplId, long uid, String date, float sbp, float dbp);
}
